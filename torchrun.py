...
if __name__ == '__main__':
    ...
    parser.add_argument('-pd', '--testDataDir', nargs='+', default=['Q:/GitHub/PRNet-PyTorch-BU/data/images/AFLW2000-crop6090'], type=str, help='test/predict image directories')
    ...
    parser.add_argument('-train', '--isTrain', default=True, type=ast.literal_eval, help='')
    ...
    parser.add_argument('--loadModelPath', default='Q:\GitHub\PRNet-PyTorch-B\savedmodel\\temp_best_model\\rot8topk\\net_027.pth',type=str, help='')
